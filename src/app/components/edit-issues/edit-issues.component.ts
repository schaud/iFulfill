...
export class EditIssuesComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    iconRegistry.addSvgIconLiteral('save_close',sanitizer.bypassSecurityTrustHtml(SVAE_CLOSE));
  }
  /////////////////////////////////////////////////////////////
  ngOnInit(): void {
    console.log('EditIssuesComponent ngOnInit', this.local_data['selectedIssues']);
    this.selectedIssues = this.local_data['selectedIssues'];

    this.dataSource = new MatTableDataSource<Issue>(this.selectedIssues);
  ...
  selectItem(e, i) {
    this.selectedIssues[i].checked = e.checked;
  }
}
